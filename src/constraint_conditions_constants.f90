...
MODULE CONSTRAINT_CONDITIONS_CONSTANTS
  ...
  !>@{
  INTEGER(INTG), PARAMETER :: NUMBER_OF_CONSTRAINT_CONDITION_TIME_TYPES=4 !<The number of constraint conditions time dependence types defined. \see CONSTRAINT_CONDITIONS_CONSTANTS_TimeDependenceTypes,CONSTRAINT_CONDITIONS_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: CONSTRAINT_CONDITION_FIRST_ORDER_DYNAMIC=2 !<The constraint conditions are first order dynamic. \see CONSTRAINT_CONDITIONS_CONSTANTS_TimeDependenceTypes,CONSTRAINT_CONDITIONS_CONSTANTS
  INTEGER(INTG), PARAMETER :: CONSTRAINT_CONDITION_SECOND_ORDER_DYNAMIC=3 !<The constraint conditions are a second order dynamic. \see CONSTRAINT_CONDITIONS_CONSTANTS_TimeDependenceTypes,EQUATIONS_ROUTINES
  INTEGER(INTG), PARAMETER :: CONSTRAINT_CONDITION_TIME_STEPPING=4 !<The constraint conditions are for time stepping. \see CONSTRAINT_CONDITIONS_CONSTANTS_TimeDependenceTypes,EQUATIONS_ROUTINES
  !>@}
