...
!!TODO: check if this can be removed and just allocate those variables that are actually used
                ...
                IF(ASSOCIATED(NONLINEAR_MAPPING)) THEN
                  ...
                  DO matrix_idx=1,NONLINEAR_MAPPING%NUMBER_OF_RESIDUAL_VARIABLES
                    ...
                    DO dof_idx=1,ROW_VARIABLE%TOTAL_NUMBER_OF_DOFS
                      !1-1 mapping for now
                      row_idx=ROW_VARIABLE%DOMAIN_MAPPING%LOCAL_TO_GLOBAL_MAP(dof_idx)
    ...
    IF(DIAGNOSTICS1) THEN
      ...
      CALL WRITE_STRING_VALUE(DIAGNOSTIC_OUTPUT_TYPE,"  Total number of rows = ",EQUATIONS_MAPPING%TOTAL_NUMBER_OF_ROWS, &
        & ERR,ERROR,*999)
