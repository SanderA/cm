      ...
      IF(ASSOCIATED(EQUATIONS)) THEN
        ...
        IF(EQUATIONS_SET%GLOBAL_NUMBER==JACOBIAN_NUMBER) THEN !Diagonal submatrix
          IF(JACOBIAN_MATRIX%UPDATE_JACOBIAN) THEN
            ...
            HYDROSTATIC_PRESSURE_FIELD_VARIABLE=>NONLINEAR_MAPPING%RESIDUAL_VARIABLES(2)%PTR
            HYDROSTATIC_PRESSURE_FIELD_VAR_TYPE=HYDROSTATIC_PRESSURE_FIELD_VARIABLE%VARIABLE_TYPE
            ...
            DEPENDENT_INTERPOLATION_PARAMETERS=>EQUATIONS%INTERPOLATION% &
              & DEPENDENT_INTERP_PARAMETERS(FIELD_VAR_TYPE)%PTR
            HYDROSTATIC_PRESSURE_INTERPOLATION_PARAMETERS=>EQUATIONS%INTERPOLATION% &
              & DEPENDENT_INTERP_PARAMETERS(HYDROSTATIC_PRESSURE_FIELD_VAR_TYPE)%PTR
            ...
            HYDROSTATIC_PRESSURE_INTERPOLATED_POINT=>EQUATIONS%INTERPOLATION% &
              & DEPENDENT_INTERP_POINT(HYDROSTATIC_PRESSURE_FIELD_VAR_TYPE)%PTR
            IF(ASSOCIATED(FIBRE_FIELD)) THEN
