...
#include "include/finclude/petscts.h"
  ...
  TYPE PETSC_IS_PTR_TYPE
    TYPE(PETSC_IS_TYPE), POINTER :: PTR
  END TYPE PETSC_IS_PTR_TYPE
  ...
  PUBLIC PETSC_IS_TYPE,PETSC_IS_PTR_TYPE,PETSC_ISLOCALTOGLOBALMAPPING_TYPE,PETSC_ISCOLORING_TYPE,PETSC_KSP_TYPE,PETSC_MAT_TYPE, &
