...
MODULE CONSTRAINT_MATRICES_ROUTINES
  ...
  PUBLIC ConstraintMatrices_ElementCalculate
...
999 CALL ERRORS("CONSTRAINT_MATRICES_ELEMENT_ADD",ERR,ERROR)
  ...
  SUBROUTINE ConstraintMatrices_ElementCalculate(constraintMatrices,constraintElementNumber,err,error,*)
...
#ifdef TAUPROF
    CALL TAU_STATIC_PHASE_START("ConstraintMatrices_ElementCalculate()")
#endif

    CALL ENTERS("ConstraintMatrices_ElementCalculate",err,error,*999)
...
#ifdef TAUPROF
    CALL TAU_STATIC_PHASE_STOP("ConstraintMatrices_ElementCalculate()")
#endif
    
    CALL EXITS("ConstraintMatrices_ElementCalculate")
    RETURN
999 CALL ERRORS("ConstraintMatrices_ElementCalculate",err,error)
    CALL EXITS("ConstraintMatrices_ElementCalculate")
    RETURN 1
  END SUBROUTINE ConstraintMatrices_ElementCalculate
