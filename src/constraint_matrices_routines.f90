...
CONTAINS
  ...
  SUBROUTINE CONSTRAINT_JACOBIAN_FINALISE(CONSTRAINT_JACOBIAN,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_JACOBIAN_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_JACOBIAN_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_JACOBIAN_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_JACOBIAN_INITIALISE(NONLINEAR_MATRICES,MATRIX_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_JACOBIAN_INITIALISE",ERR,ERROR,*998)
...
998 ERRORSEXITS("CONSTRAINT_JACOBIAN_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE CONSTRAINT_MATRICES_CREATE_FINISH(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_CREATE_FINISH",ERR,ERROR,*998)
  ...
  !!TODO: Set the distributed matrix not to allocate the data if the Jacobian is not calculated.
    ...
    EXITS("CONSTRAINT_MATRICES_CREATE_FINISH")
    RETURN
...
998 ERRORSEXITS("CONSTRAINT_MATRICES_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_CREATE_START(CONSTRAINT_EQUATIONS,CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_CREATE_START",ERR,ERROR,*998)
...
998 ERRORSEXITS("CONSTRAINT_MATRICES_CREATE_START",ERR,ERROR)
  ...
  SUBROUTINE CONSTRAINT_MATRICES_DESTROY(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_DESTROY",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_DESTROY")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_DESTROY",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_MATRIX_CALCULATE(ELEMENT_MATRIX,UPDATE_MATRIX,hasTranspose, &
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_CALCULATE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_CALCULATE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_CALCULATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_MATRIX_FINALISE(ELEMENT_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_MATRIX_INITIALISE(ELEMENT_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_INITIALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_MATRIX_SETUP(elementMatrix,rowsFieldVariable,columnsFieldVariable, &
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_SETUP",err,error,*998)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_SETUP")
    RETURN
999 CALL CONSTRAINT_MATRICES_ELEMENT_MATRIX_FINALISE(elementMatrix,dummyErr,dummyError,*998)
998 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_MATRIX_SETUP",err,error)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_VECTOR_CALCULATE(ELEMENT_VECTOR,UPDATE_VECTOR,ELEMENT_NUMBER,ROWS_FIELD_VARIABLE, &
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_CALCULATE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_CALCULATE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_CALCULATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_VECTOR_FINALISE(ELEMENT_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_VECTOR_INITIALISE(ELEMENT_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_INITIALISE",ERR,ERROR,*999)

    ELEMENT_VECTOR%NUMBER_OF_ROWS=0
    ELEMENT_VECTOR%MAX_NUMBER_OF_ROWS=0
       
    EXITS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_INITIALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_VECTOR_SETUP(elementVector,rowsFieldVariable,err,error,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_SETUP",err,error,*998)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_SETUP")
    RETURN
999 CALL CONSTRAINT_MATRICES_ELEMENT_VECTOR_FINALISE(elementVector,DUMMY_ERR,dummyError,*998)
998 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_VECTOR_SETUP",err,error)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_ADD(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_ADD",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_ADD")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_ADD",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_CALCULATE(CONSTRAINT_MATRICES,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_CALCULATE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_CALCULATE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_CALCULATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_FINALISE(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_ELEMENT_INITIALISE(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_ELEMENT_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_ELEMENT_INITIALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_ELEMENT_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRIX_FINALISE(CONSTRAINT_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRIX_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRIX_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRIX_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRIX_DYNAMIC_INITIALISE(DYNAMIC_MATRICES,MATRIX_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRIX_DYNAMIC_INITIALISE",ERR,ERROR,*998)
...
998 ERRORSEXITS("CONSTRAINT_MATRIX_DYNAMIC_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE CONSTRAINT_MATRIX_LINEAR_INITIALISE(LINEAR_MATRICES,MATRIX_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRIX_LINEAR_INITIALISE",ERR,ERROR,*998)
...
998 ERRORSEXITS("CONSTRAINT_MATRIX_LINEAR_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE CONSTRAINT_MATRICES_DYNAMIC_FINALISE(DYNAMIC_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_DYNAMIC_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_DYNAMIC_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_DYNAMIC_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_DYNAMIC_INITIALISE(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_DYNAMIC_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_MATRICES_DYNAMIC_INITIALISE")
    RETURN
999 CALL CONSTRAINT_MATRICES_DYNAMIC_FINALISE(CONSTRAINT_MATRICES%DYNAMIC_MATRICES,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_MATRICES_DYNAMIC_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_JACOBIAN_ELEMENT_ADD(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_JACOBIAN_ELEMENT_ADD",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_JACOBIAN_ELEMENT_ADD")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_JACOBIAN_ELEMENT_ADD",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_JACOBIAN_OUTPUT(ID,CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_JACOBIAN_OUTPUT",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_JACOBIAN_OUTPUT")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_JACOBIAN_OUTPUT",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_LINEAR_FINALISE(LINEAR_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_LINEAR_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_LINEAR_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_LINEAR_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_LINEAR_INITIALISE(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_LINEAR_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_MATRICES_LINEAR_INITIALISE")
    RETURN
999 CALL CONSTRAINT_MATRICES_LINEAR_FINALISE(CONSTRAINT_MATRICES%LINEAR_MATRICES,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_MATRICES_LINEAR_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_NONLINEAR_FINALISE(NONLINEAR_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_NONLINEAR_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_NONLINEAR_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_NONLINEAR_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_NONLINEAR_INITIALISE(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_NONLINEAR_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_MATRICES_NONLINEAR_INITIALISE")
    RETURN
999 CALL CONSTRAINT_MATRICES_NONLINEAR_FINALISE(CONSTRAINT_MATRICES%NONLINEAR_MATRICES,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_MATRICES_NONLINEAR_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_OUTPUT(ID,CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_OUTPUT",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_OUTPUT")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_OUTPUT",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_RHS_FINALISE(RHS_VECTOR,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_RHS_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_RHS_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_RHS_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_RHS_INITIALISE(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_RHS_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_MATRICES_RHS_INITIALISE")
    RETURN
999 CALL CONSTRAINT_MATRICES_RHS_FINALISE(CONSTRAINT_MATRICES%RHS_VECTOR,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_MATRICES_RHS_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_DYNAMIC_STORAGE_TYPE_SET(CONSTRAINT_MATRICES,STORAGE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_DYNAMIC_STORAGE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_DYNAMIC_STORAGE_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_DYNAMIC_STORAGE_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_LINEAR_STORAGE_TYPE_SET(CONSTRAINT_MATRICES,STORAGE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_LINEAR_STORAGE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_LINEAR_STORAGE_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_LINEAR_STORAGE_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_NONLINEAR_STORAGE_TYPE_SET_0(CONSTRAINT_MATRICES,STORAGE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_NONLINEAR_STORAGE_TYPE_SET_0",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_NONLINEAR_STORAGE_TYPE_SET_0")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_NONLINEAR_STORAGE_TYPE_SET_0",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_NONLINEAR_STORAGE_TYPE_SET_1(CONSTRAINT_MATRICES,STORAGE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_NONLINEAR_STORAGE_TYPE_SET_1",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_NONLINEAR_STORAGE_TYPE_SET_1")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_NONLINEAR_STORAGE_TYPE_SET_1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_DYNAMIC_STRUCTURE_TYPE_SET(CONSTRAINT_MATRICES,STRUCTURE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_DYNAMIC_STRUCTURE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_DYNAMIC_STRUCTURE_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_DYNAMIC_STRUCTURE_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_LINEAR_STRUCTURE_TYPE_SET(CONSTRAINT_MATRICES,STRUCTURE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_LINEAR_STRUCTURE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_LINEAR_STRUCTURE_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_LINEAR_STRUCTURE_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_0(CONSTRAINT_MATRICES,STRUCTURE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_0",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_0")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_0",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_1(CONSTRAINT_MATRICES,STRUCTURE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_1",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_1")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_NONLINEAR_STRUCTURE_TYPE_SET_1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_FINALISE(CONSTRAINT_MATRICES,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_INITIALISE(CONSTRAINT_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_MATRICES_INITIALISE")
    RETURN
999 CALL CONSTRAINT_MATRICES_FINALISE(CONSTRAINT_EQUATIONS%CONSTRAINT_MATRICES,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_MATRICES_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRICES_VALUES_INITIALISE(CONSTRAINT_MATRICES,SELECTION_TYPE,VALUE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MATRICES_VALUES_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRICES_VALUES_INITIALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MATRICES_VALUES_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MATRIX_STRUCTURE_CALCULATE(CONSTRAINT_MATRIX,NUMBER_OF_NON_ZEROS,ROW_INDICES,COLUMN_INDICES, &
   ...
   INTEGER(INTG) :: column_version,column_derivative,column_idx,column_component_idx,column_local_derivative_idx, &
    ...
    ENTERS("CONSTRAINT_MATRIX_STRUCTURE_CALCULATE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MATRIX_STRUCTURE_CALCULATE")
    RETURN
999 IF(ASSOCIATED(ROW_INDICES)) DEALLOCATE(ROW_INDICES)
    IF(ASSOCIATED(COLUMN_INDICES)) DEALLOCATE(COLUMN_INDICES)
    IF(ASSOCIATED(TRANSPOSE_ROW_INDICES)) DEALLOCATE(TRANSPOSE_ROW_INDICES)
    ...
    ENDIF
998 ERRORSEXITS("CONSTRAINT_MATRIX_STRUCTURE_CALCULATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_JACOBIAN_STRUCTURE_CALCULATE(CONSTRAINT_JACOBIAN,NUMBER_OF_NON_ZEROS,ROW_INDICES,COLUMN_INDICES, &
   ...
   INTEGER(INTG) :: column_version,column_derivative,column_idx,column_component_idx,column_local_derivative_idx, &
    ...
    ENTERS("CONSTRAINT_JACOBIAN_STRUCTURE_CALCULATE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_JACOBIAN_STRUCTURE_CALCULATE")
    RETURN
999 IF(ASSOCIATED(ROW_INDICES)) DEALLOCATE(ROW_INDICES)
    IF(ASSOCIATED(COLUMN_INDICES)) DEALLOCATE(COLUMN_INDICES)
    IF(ASSOCIATED(TRANSPOSE_ROW_INDICES)) DEALLOCATE(TRANSPOSE_ROW_INDICES)
    ...
    IF(ALLOCATED(TRANSPOSE_COLUMN_INDICES_LISTS)) THEN
      ...
      DEALLOCATE(TRANSPOSE_COLUMN_INDICES_LISTS)
    ENDIF
998 ERRORSEXITS("CONSTRAINT_JACOBIAN_STRUCTURE_CALCULATE",ERR,ERROR)
    RETURN 1
