...
CONTAINS
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_CREATE_FINISH(CONSTRAINT_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_CREATE_FINISH",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_CREATE_FINISH")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_CREATE_START(CONSTRAINT_CONDITION,CONSTRAINT_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_CREATE_START",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_CREATE_START")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_CREATE_START",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_DESTROY(CONSTRAINT_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_DESTROY",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_DESTROY")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_DESTROY",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_FINALISE(CONSTRAINT_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_INITIALISE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_INITIALISE",ERR,ERROR,*998)
...
998 ERRORSEXITS("CONSTRAINT_EQUATIONS_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_INTERPOLATION_FINALISE(CONSTRAINT_EQUATIONS_INTERPOLATION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_INTERPOLATION_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_INTERPOLATION_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_INTERPOLATION_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_INTERPOLATION_INITIALISE(CONSTRAINT_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_INTERPOLATION_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_EQUATIONS_INTERPOLATION_INITIALISE")
    RETURN
999 CALL CONSTRAINT_EQUATIONS_INTERPOLATION_FINALISE(CONSTRAINT_EQUATIONS%INTERPOLATION,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_EQUATIONS_INTERPOLATION_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_LINEARITY_TYPE_GET(CONSTRAINT_EQUATIONS,LINEARITY_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_LINEARITY_TYPE_GET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_LINEARITY_TYPE_GET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_LINEARITY_TYPE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_LINEARITY_TYPE_SET(CONSTRAINT_EQUATIONS,LINEARITY_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_LINEARITY_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_LINEARITY_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_LINEARITY_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_OUTPUT_TYPE_GET(CONSTRAINT_EQUATIONS,OUTPUT_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_OUTPUT_TYPE_GET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_OUTPUT_TYPE_GET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_OUTPUT_TYPE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_OUTPUT_TYPE_SET(CONSTRAINT_EQUATIONS,OUTPUT_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_OUTPUT_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_OUTPUT_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_OUTPUT_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_SPARSITY_TYPE_GET(CONSTRAINT_EQUATIONS,SPARSITY_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_SPARSITY_TYPE_GET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_SPARSITY_TYPE_GET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_SPARSITY_TYPE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_SPARSITY_TYPE_SET(CONSTRAINT_EQUATIONS,SPARSITY_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_SPARSITY_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_SPARSITY_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_SPARSITY_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_TIME_DEPENDENCE_TYPE_GET(CONSTRAINT_EQUATIONS,TIME_DEPENDENCE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_TIME_DEPENDENCE_TYPE_GET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_TIME_DEPENDENCE_TYPE_GET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_TIME_DEPENDENCE_TYPE_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_TIME_DEPENDENCE_TYPE_SET(CONSTRAINT_EQUATIONS,TIME_DEPENDENCE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_EQUATIONS_TIME_DEPENDENCE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_EQUATIONS_TIME_DEPENDENCE_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_EQUATIONS_TIME_DEPENDENCE_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_CONSTRAINT_EQUATIONS_GET(CONSTRAINT_CONDITION,CONSTRAINT_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_CONSTRAINT_EQUATIONS_GET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_CONSTRAINT_EQUATIONS_GET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_CONSTRAINT_EQUATIONS_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_NumberOfLinearMatricesGet(constraintEquations,numberOfMatrices,err,error,*)
    ...
    ENTERS("ConstraintEquations_NumberOfLinearMatricesGet",err,error,*999)
    ...
    EXITS("ConstraintEquations_NumberOfLinearMatricesGet")
    RETURN
999 ERRORSEXITS("ConstraintEquations_NumberOfLinearMatricesGet",err,error)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_NumberOfJacobianMatricesGet(constraintEquations,numberOfMatrices,err,error,*)
    ...
    ENTERS("ConstraintEquations_NumberOfJacobianMatricesGet",err,error,*999)
    ...
    EXITS("ConstraintEquations_NumberOfJacobianMatricesGet")
    RETURN
999 ERRORSEXITS("ConstraintEquations_NumberOfJacobianMatricesGet",err,error)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_NumberOfDynamicMatricesGet(constraintEquations,numberOfMatrices,err,error,*)
    ...
    ENTERS("ConstraintEquations_NumberOfDynamicMatricesGet",err,error,*999)
    ...
    EXITS("ConstraintEquations_NumberOfDynamicMatricesGet")
    RETURN
999 ERRORSEXITS("ConstraintEquations_NumberOfDynamicMatricesGet",err,error)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_LinearMatrixGet(constraintEquations,matrixIndex,matrix,err,error,*)
    ...
    ENTERS("ConstraintEquations_LinearMatrixGet",err,error,*999)
    ...
    EXITS("ConstraintEquations_LinearMatrixGet")
    RETURN
999 ERRORSEXITS("ConstraintEquations_LinearMatrixGet",err,error)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_JacobianMatrixGet(constraintEquations,matrixIndex,matrix,err,error,*)
    ...
    ENTERS("ConstraintEquations_JacobianMatrixGet",err,error,*999)
    ...
    EXITS("ConstraintEquations_JacobianMatrixGet")
    RETURN
999 ERRORSEXITS("ConstraintEquations_JacobianMatrixGet",err,error)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_DynamicMatrixGet(constraintEquations,matrixIndex,matrix,err,error,*)
    ...
    ENTERS("ConstraintEquations_DynamicMatrixGet",err,error,*999)
    ...
    EXITS("ConstraintEquations_DynamicMatrixGet")
    RETURN
999 ERRORSEXITS("ConstraintEquations_DynamicMatrixGet",err,error)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_DynamicMatrixGetByType(constraintEquations,matrixType,matrix,err,error,*)
    ...
    ENTERS("ConstraintEquations_DynamicMatrixGetByType",err,error,*999)
    ...
    EXITS("ConstraintEquations_DynamicMatrixGetByType")
    RETURN
999 ERRORSEXITS("ConstraintEquations_DynamicMatrixGetByType",err,error)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_DynamicMatrixTypeGet(constraintEquations,matrixIndex,matrixType,err,error,*)
    ...
    ENTERS("ConstraintEquations_DynamicMatrixTypeGet",err,error,*999)
    ...
    EXITS("ConstraintEquations_DynamicMatrixTypeGet")
    RETURN
999 ERRORSEXITS("ConstraintEquations_DynamicMatrixTypeGet",err,error)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_RhsVectorGet(constraintEquations,vector,err,error,*)
    ...
    ENTERS("ConstraintEquations_RhsVectorGet",err,error,*999)
    ...
    EXITS("ConstraintEquations_RhsVectorGet")
    RETURN
999 ERRORSEXITS("ConstraintEquations_RhsVectorGet",err,error)
    RETURN 1
  ...
  SUBROUTINE ConstraintEquations_ResidualVectorGet(constraintEquations,vector,err,error,*)
    ...
    ENTERS("ConstraintEquations_ResidualVectorGet",err,error,*999)
    ...
    EXITS("ConstraintEquations_ResidualVectorGet")
    RETURN
999 ERRORSEXITS("ConstraintEquations_ResidualVectorGet",err,error)
    RETURN 1
