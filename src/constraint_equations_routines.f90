...
MODULE CONSTRAINT_EQUATIONS_ROUTINES
 ...
 !>@}
  ...
  PUBLIC CONSTRAINT_CONDITION_LINEARITY_TYPE_GET,CONSTRAINT_CONDITION_LINEARITY_TYPE_SET
...
998 CALL ERRORS("CONSTRAINT_EQUATIONS_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE CONSTRAINT_EQUATIONS_INTERPOLATION_FINALISE(CONSTRAINT_EQUATIONS_INTERPOLATION,ERR,ERROR,*)
    ...
    IF(ASSOCIATED(CONSTRAINT_EQUATIONS_INTERPOLATION)) THEN
      ...
      CALL FIELD_INTERPOLATED_POINTS_METRICS_FINALISE(CONSTRAINT_EQUATIONS_INTERPOLATION% &
    ...
    IF(ASSOCIATED(CONSTRAINT_EQUATIONS)) THEN
      ...
      IF(ASSOCIATED(CONSTRAINT_CONDITION)) THEN
        ...
        ELSE
          ...
          CALL FIELD_INTERPOLATED_POINTS_METRICS_INITIALISE(CONSTRAINT_EQUATIONS%INTERPOLATION%GEOMETRIC_INTERP_POINT, &
          ...
          IF(CONSTRAINT_EQUATIONS%INTERPOLATION%DEPENDENT_FIELD%TYPE==FIELD_GEOMETRIC_TYPE.OR. &
            ...
            CALL FIELD_INTERPOLATED_POINTS_METRICS_INITIALISE(CONSTRAINT_EQUATIONS%INTERPOLATION%DEPENDENT_INTERP_POINT, &
...
998 CALL ERRORS("CONSTRAINT_EQUATIONS_INTERPOLATION_INITIALISE",ERR,ERROR)
  ...
  SUBROUTINE CONSTRAINT_CONDITION_LINEARITY_TYPE_GET(CONSTRAINT_EQUATIONS,LINEARITY_TYPE,ERR,ERROR,*)
    ...
    CALL ENTERS("CONSTRAINT_CONDITION_LINEARITY_TYPE_GET",ERR,ERROR,*999)
    ...
    CALL EXITS("CONSTRAINT_CONDITION_LINEARITY_TYPE_GET")
    RETURN
999 CALL ERRORS("CONSTRAINT_CONDITION_LINEARITY_TYPE_GET",ERR,ERROR)
    CALL EXITS("CONSTRAINT_CONDITION_LINEARITY_TYPE_GET")
    RETURN 1
  END SUBROUTINE CONSTRAINT_CONDITION_LINEARITY_TYPE_GET
  ...
  SUBROUTINE CONSTRAINT_CONDITION_LINEARITY_TYPE_SET(CONSTRAINT_EQUATIONS,LINEARITY_TYPE,ERR,ERROR,*)
    ...
    CALL ENTERS("CONSTRAINT_CONDITION_LINEARITY_TYPE_SET",ERR,ERROR,*999)
    ...
    CALL EXITS("CONSTRAINT_CONDITION_LINEARITY_TYPE_SET")
    RETURN
999 CALL ERRORS("CONSTRAINT_CONDITION_LINEARITY_TYPE_SET",ERR,ERROR)
    CALL EXITS("CONSTRAINT_CONDITION_LINEARITY_TYPE_SET")
    RETURN 1
  END SUBROUTINE CONSTRAINT_CONDITION_LINEARITY_TYPE_SET
