...
999 ERRORSEXITS( "FIELDML_OUTPUT_ADD_MESH_COMPONENT", ERR, ERROR )
  ...
  SUBROUTINE FIELDML_OUTPUT_ADD_FIELD_NODE_DOFS( FIELDML_INFO, BASE_NAME, DOF_FORMAT, TYPE_HANDLE, FIELD, &
    ...
    INTEGER(INTG) :: VERSION_NUMBER,COMPONENT_COUNT, I, J, INTERPOLATION_TYPE, RANK
    ...
    DO I = 1, NODE_COUNT
      DO J = 1, COMPONENT_COUNT
        ...
        IF( IS_NODE_BASED(J) ) THEN
          ...
          CALL DOMAIN_TOPOLOGY_NODE_CHECK_EXISTS(FIELD%DECOMPOSITION%DOMAIN(meshComponentNumber)%PTR%TOPOLOGY, &
            & I,NODE_EXISTS,DOMAIN_LOCAL_NODE_NUMBER,GHOST_NODE,ERR,ERROR,*999)
