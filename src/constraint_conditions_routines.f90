...
CONTAINS
  ...
  SUBROUTINE CONSTRAINT_CONDITION_ASSEMBLE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_ASSEMBLE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_ASSEMBLE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_ASSEMBLE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_ASSEMBLE_DYNAMIC_LINEAR_FEM(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_ASSEMBLE_DYNAMIC_LINEAR_FEM",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_ASSEMBLE_DYNAMIC_LINEAR_FEM")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_ASSEMBLE_DYNAMIC_LINEAR_FEM",ERR,ERROR)
    RETURN 1
...
!#endif
    ...
    ENTERS("CONSTRAINT_CONDITION_ASSEMBLE_STATIC_LINEAR_FEM",ERR,ERROR,*999)
...
!#endif
    ...
    EXITS("CONSTRAINT_CONDITION_ASSEMBLE_STATIC_LINEAR_FEM")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_ASSEMBLE_STATIC_LINEAR_FEM",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_ASSEMBLE_STATIC_NONLINEAR_FEM(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_ASSEMBLE_STATIC_NONLINEAR_FEM",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_ASSEMBLE_STATIC_NONLINEAR_FEM")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_ASSEMBLE_STATIC_NONLINEAR_FEM",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_CREATE_FINISH(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_CREATE_FINISH",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_CREATE_FINISH")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_CREATE_START(USER_NUMBER,EQUATIONS_SET,CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_CREATE_START",ERR,ERROR,*997)
    ...
    EXITS("CONSTRAINT_CONDITION_CREATE_START")
    RETURN
...
997 ERRORSEXITS("CONSTRAINT_CONDITION_CREATE_START",ERR,ERROR)
    RETURN 1   
  ...
  SUBROUTINE CONSTRAINT_CONDITION_DESTROY_NUMBER(USER_NUMBER,REGION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_DESTROY_NUMBER",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_DESTROY_NUMBER")
    RETURN
999 IF(ASSOCIATED(NEW_CONSTRAINT_CONDITIONS)) DEALLOCATE(NEW_CONSTRAINT_CONDITIONS)
998 ERRORSEXITS("CONSTRAINT_CONDITION_DESTROY_NUMBER",ERR,ERROR)
    RETURN 1   
  ...
  SUBROUTINE CONSTRAINT_CONDITION_DESTROY(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_DESTROY",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_DESTROY")
    RETURN
999 IF(ASSOCIATED(NEW_CONSTRAINT_CONDITIONS)) DEALLOCATE(NEW_CONSTRAINT_CONDITIONS)
998 ERRORSEXITS("CONSTRAINT_CONDITION_DESTROY",ERR,ERROR)
    RETURN 1   
  ...
  SUBROUTINE CONSTRAINT_CONDITION_FINALISE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_FINITE_ELEMENT_CALCULATE(CONSTRAINT_CONDITION,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_FINITE_ELEMENT_CALCULATE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_FINITE_ELEMENT_CALCULATE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_FINITE_ELEMENT_CALCULATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_FINITE_ELEMENT_JACOBIAN_EVALUATE(CONSTRAINT_CONDITION,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_FINITE_ELEMENT_JACOBIAN_EVALUATE",ERR,ERROR,*999)
...
!!TODO: Write out the element residual???
    ...
    EXITS("CONSTRAINT_CONDITION_FINITE_ELEMENT_JACOBIAN_EVALUATE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_FINITE_ELEMENT_JACOBIAN_EVALUATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_FINITE_ELEMENT_RESIDUAL_EVALUATE(CONSTRAINT_CONDITION,ELEMENT_NUMBER,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_FINITE_ELEMENT_RESIDUAL_EVALUATE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_FINITE_ELEMENT_RESIDUAL_EVALUATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_INITIALISE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_CONDITION_INITIALISE")
    RETURN
999 CALL CONSTRAINT_CONDITION_FINALISE(CONSTRAINT_CONDITION,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_CONDITION_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_GEOMETRY_FINALISE(CONSTRAINT_GEOMETRY,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_GEOMETRY_FINALISE",ERR,ERROR,*999)
    
    NULLIFY(CONSTRAINT_GEOMETRY%GEOMETRIC_FIELD)
       
    EXITS("CONSTRAINT_CONDITION_GEOMETRY_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_GEOMETRY_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_GEOMETRY_INITIALISE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_GEOMETRY_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_GEOMETRY_INITIALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_GEOMETRY_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_DEPENDENT_FINALISE(CONSTRAINT_DEPENDENT,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_DEPENDENT_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_DEPENDENT_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_DEPENDENT_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_DEPENDENT_INITIALISE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_DEPENDENT_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_CONDITION_DEPENDENT_INITIALISE")
    RETURN
999 CALL CONSTRAINT_CONDITION_DEPENDENT_FINALISE(CONSTRAINT_CONDITION%DEPENDENT,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_CONDITION_DEPENDENT_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_EQUATIONS_CREATE_FINISH(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITIONS_EQUATIONS_CREATE_FINISH",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_EQUATIONS_CREATE_FINISH")
    RETURN
999 IF(ALLOCATED(MATRICES_TRANSPOSE)) DEALLOCATE(MATRICES_TRANSPOSE)
    ...
    ERRORSEXITS("CONSTRAINT_CONDITION_EQUATIONS_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_EQUATIONS_CREATE_START(CONSTRAINT_CONDITION,CONSTRAINT_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_EQUATIONS_CREATE_START",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_EQUATIONS_CREATE_START")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_EQUATIONS_CREATE_START",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_EQUATIONS_DESTROY(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_EQUATIONS_DESTROY",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_EQUATIONS_DESTROY")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_EQUATIONS_DESTROY",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_JACOBIAN_EVALUATE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_JACOBIAN_EVALUATE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_JACOBIAN_EVALUATE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_JACOBIAN_EVALUATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_JACOBIAN_EVALUATE_STATIC_FEM(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_JACOBIAN_EVALUATE_STATIC_FEM",ERR,ERROR,*999)
...
!!Do we need to transfer parameter sets???
    ...
    EXITS("CONSTRAINT_CONDITION_JACOBIAN_EVALUATE_STATIC_FEM")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_JACOBIAN_EVALUATE_STATIC_FEM",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_JACOBIAN_EVALUATE_DYNAMIC_FEM(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_JACOBIAN_EVALUATE_DYNAMIC_FEM",ERR,ERROR,*999)
...
!!Do we need to transfer parameter sets???
    ...
    EXITS("CONSTRAINT_CONDITION_JACOBIAN_EVALUATE_DYNAMIC_FEM")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_JACOBIAN_EVALUATE_DYNAMIC_FEM",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_LAGRANGE_FIELD_CREATE_FINISH(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_LAGRANGE_FIELD_CREATE_FINISH",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_LAGRANGE_FIELD_CREATE_FINISH")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_LAGRANGE_FIELD_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_LAGRANGE_FIELD_CREATE_START(CONSTRAINT_CONDITION,LAGRANGE_FIELD_USER_NUMBER,LAGRANGE_FIELD, &
    ...
    ENTERS("CONSTRAINT_CONDITION_LAGRANGE_FIELD_CREATE_START",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_LAGRANGE_FIELD_CREATE_START")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_LAGRANGE_FIELD_CREATE_START",ERR,ERROR)
    RETURN 1   
  ...
  SUBROUTINE CONSTRAINT_CONDITION_LAGRANGE_FINALISE(CONSTRAINT_LAGRANGE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_LAGRANGE_FINALISE",ERR,ERROR,*999)

    IF(ASSOCIATED(CONSTRAINT_LAGRANGE)) THEN
      DEALLOCATE(CONSTRAINT_LAGRANGE)
    ENDIF
       
    EXITS("CONSTRAINT_CONDITION_LAGRANGE_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_LAGRANGE_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_LAGRANGE_INITIALISE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_LAGRANGE_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_CONDITION_LAGRANGE_INITIALISE")
    RETURN
999 CALL CONSTRAINT_CONDITION_LAGRANGE_FINALISE(CONSTRAINT_CONDITION%LAGRANGE,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_CONDITION_LAGRANGE_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_PENALTY_FIELD_CREATE_FINISH(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_PENALTY_FIELD_CREATE_FINISH",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_PENALTY_FIELD_CREATE_FINISH")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_PENALTY_FIELD_CREATE_FINISH",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_PENALTY_FIELD_CREATE_START(CONSTRAINT_CONDITION,PENALTY_FIELD_USER_NUMBER,PENALTY_FIELD, &
    ...
    ENTERS("CONSTRAINT_CONDITION_PENALTY_FIELD_CREATE_START",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_PENALTY_FIELD_CREATE_START")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_PENALTY_FIELD_CREATE_START",ERR,ERROR)
    RETURN 1   
  ...
  SUBROUTINE CONSTRAINT_CONDITION_PENALTY_FINALISE(CONSTRAINT_PENALTY,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_PENALTY_FINALISE",ERR,ERROR,*999)

    IF(ASSOCIATED(CONSTRAINT_PENALTY)) THEN
      DEALLOCATE(CONSTRAINT_PENALTY)
    ENDIF
       
    EXITS("CONSTRAINT_CONDITION_PENALTY_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_PENALTY_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_PENALTY_INITIALISE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_PENALTY_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_CONDITION_PENALTY_INITIALISE")
    RETURN
999 CALL CONSTRAINT_CONDITION_PENALTY_FINALISE(CONSTRAINT_CONDITION%PENALTY,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_CONDITION_PENALTY_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_METHOD_GET(CONSTRAINT_CONDITION,CONSTRAINT_CONDITION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_METHOD_GET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_METHOD_GET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_METHOD_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_METHOD_SET(CONSTRAINT_CONDITION,CONSTRAINT_CONDITION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_METHOD_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_METHOD_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_METHOD_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_OPERATOR_GET(CONSTRAINT_CONDITION,CONSTRAINT_CONDITION_OPERATOR,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_OPERATOR_GET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_OPERATOR_GET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_OPERATOR_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_OPERATOR_SET(CONSTRAINT_CONDITION,CONSTRAINT_CONDITION_OPERATOR,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_OPERATOR_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_OPERATOR_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_OPERATOR_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_RESIDUAL_EVALUATE(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_RESIDUAL_EVALUATE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_RESIDUAL_EVALUATE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_RESIDUAL_EVALUATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_RESIDUAL_EVALUATE_DYNAMIC_FEM(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_RESIDUAL_EVALUATE_DYNAMIC_FEM",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_RESIDUAL_EVALUATE_DYNAMIC_FEM")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_RESIDUAL_EVALUATE_DYNAMIC_FEM",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_RESIDUAL_EVALUATE_STATIC_FEM(CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_RESIDUAL_EVALUATE_STATIC_FEM",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_RESIDUAL_EVALUATE_STATIC_FEM")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_RESIDUAL_EVALUATE_STATIC_FEM",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_SOLUTION_METHOD_SET(CONSTRAINT_CONDITION,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_SOLUTION_METHOD_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_SOLUTION_METHOD_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_SOLUTION_METHOD_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_SOLUTION_METHOD_GET(CONSTRAINT_CONDITION,SOLUTION_METHOD,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_SOLUTION_METHOD_GET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_SOLUTION_METHOD_GET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_SOLUTION_METHOD_GET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_USER_NUMBER_FIND(USER_NUMBER,REGION,CONSTRAINT_CONDITION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_USER_NUMBER_FIND",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_USER_NUMBER_FIND")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_USER_NUMBER_FIND",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITIONS_FINALISE(REGION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITIONS_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITIONS_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITIONS_FINALISE",ERR,ERROR)
    RETURN 1   
  ...
  SUBROUTINE CONSTRAINT_CONDITIONS_INITIALISE(REGION,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITIONS_INITIALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITIONS_INITIALISE")
    RETURN
999 IF(ASSOCIATED(REGION%CONSTRAINT_CONDITIONS)) DEALLOCATE(REGION%CONSTRAINT_CONDITIONS)
998 ERRORSEXITS("CONSTRAINT_CONDITIONS_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_CONDITION_EQUATIONS_GET(CONSTRAINT_CONDITION,CONSTRAINT_EQUATIONS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_CONDITION_EQUATIONS_GET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_CONDITION_EQUATIONS_GET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_CONDITION_EQUATIONS_GET",ERR,ERROR)
    RETURN 1
