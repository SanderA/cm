...
MODULE EQUATIONS_SET_CONSTANTS
  ...
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_CONSTRAINTS_CLASS=10
 ...
 !Bioelectrics class
  ...
  !Constraints class
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBILITY_TYPE=1
...
!  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_INCOMPRESSIBLE_ELAST_MULTI_COMP_DARCY_SUBTYPE=14
  ...
  !Constraints class
  INTEGER(INTG), PARAMETER :: EQUATIONS_SET_ELASTIC_INCOMPRESSIBILITY_SUBTYPE=1
