...
999 CALL ERRORS("COMPUTATIONAL_ENVIRONMENT_FINALISE",ERR,ERROR)
  ...
  SUBROUTINE COMPUTATIONAL_ENVIRONMENT_INITIALISE(ERR,ERROR,*)
    ...
    TYPE(VARYING_STRING), INTENT(OUT) :: ERROR !<The error string
    !Local Variables
    INTEGER(INTG) :: i,DUMMY_ERR,MPI_IERROR,RANK,PROVIDED_THREAD_SUPPORT
...
#ifdef _OPENMP
    CALL MPI_INIT_THREAD(MPI_THREAD_FUNNELED,PROVIDED_THREAD_SUPPORT,MPI_IERROR)
    CALL MPI_ERROR_CHECK("MPI_INIT_THREAD",MPI_IERROR,ERR,ERROR,*999)
#else
