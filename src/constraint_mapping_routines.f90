...
CONTAINS
  ...
  SUBROUTINE CONSTRAINT_MAPPING_CALCULATE(CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_CALCULATE",ERR,ERROR,*999)
                    ...
                    DO matrix_idx=1,number_of_constraint_matrices
                      ...
                      IF(ASSOCIATED(EQUATIONS_SET)) THEN
                        ...
                        IF(ASSOCIATED(FIELD_VARIABLE)) THEN
                          ...
                          ALLOCATE(DYNAMIC_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)%VARIABLE_DOF_TO_ROWS_MAP( &
                            & FIELD_VARIABLE%TOTAL_NUMBER_OF_DOFS),STAT=ERR)
                          IF(ERR/=0) CALL FLAG_ERROR("Could not allocate constraint matrix rows to variable maps dof to rows map.", &
                            & ERR,ERROR,*999)
                          ...
                          !1-1 mappings for now.
                            ...
                            DYNAMIC_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)% &
                              & VARIABLE_DOF_TO_ROWS_MAP(dof_idx)=row_idx
                          ENDDO !dof_idx
                        ELSE
                    ...
                    IF(ASSOCIATED(EQUATIONS_SET)) THEN
                      ...
                      IF(ASSOCIATED(FIELD_VARIABLE)) THEN
                        ...
                        LINEAR_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)%ROW_DOFS_MAPPING=> &
                          & FIELD_VARIABLE%DOMAIN_MAPPING
                        ALLOCATE(LINEAR_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)%VARIABLE_DOF_TO_ROWS_MAP( &
                          & FIELD_VARIABLE%TOTAL_NUMBER_OF_DOFS),STAT=ERR)
                        ...
                        DO dof_idx=1,FIELD_VARIABLE%TOTAL_NUMBER_OF_DOFS
                          !1-1 mappings for now.
                          row_idx=FIELD_VARIABLE%DOMAIN_MAPPING%LOCAL_TO_GLOBAL_MAP(dof_idx)
                          LINEAR_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)%VARIABLE_DOF_TO_ROWS_MAP(row_idx)=dof_idx
                        ENDDO !dof_idx
                      ELSE
                        CALL FLAG_ERROR("Dependent variable could not be found.",ERR,ERROR,*999)
                      ENDIF
                        ...
                        IF(ASSOCIATED(FIELD_VARIABLE)) THEN
                          ...
                          DO dof_idx=1,FIELD_VARIABLE%TOTAL_NUMBER_OF_DOFS
                            ...
                            LINEAR_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)% &
                              & VARIABLE_DOF_TO_ROWS_MAP(row_idx)=dof_idx
                          ENDDO !dof_idx
                        ELSE
                          CALL FLAG_ERROR("Lagrange variable could not be found.",ERR,ERROR,*999)
                        ENDIF
                    ...
                    IF(ASSOCIATED(EQUATIONS_SET)) THEN
                      ...
                      IF(ASSOCIATED(FIELD_VARIABLE)) THEN
                        ...
                        NONLINEAR_MAPPING%CONSTRAINT_JACOBIAN_ROWS_TO_VAR_MAP(matrix_idx)%ROW_DOFS_MAPPING=> &
                          & FIELD_VARIABLE%DOMAIN_MAPPING
                        ALLOCATE(NONLINEAR_MAPPING%CONSTRAINT_JACOBIAN_ROWS_TO_VAR_MAP(matrix_idx)%VARIABLE_DOF_TO_ROWS_MAP( &
                          & FIELD_VARIABLE%TOTAL_NUMBER_OF_DOFS),STAT=ERR)
                        IF(ERR/=0) CALL FLAG_ERROR("Could not allocate variable to constraint matrices maps dof to rows map.", &
                          & ERR,ERROR,*999)
                        DO dof_idx=1,FIELD_VARIABLE%TOTAL_NUMBER_OF_DOFS
   ...
   ENDIF
      ...
      IF(ASSOCIATED(DYNAMIC_MAPPING)) THEN
        ...
        DO matrix_idx=1,DYNAMIC_MAPPING%NUMBER_OF_DYNAMIC_CONSTRAINT_MATRICES
          ...
          CALL WRITE_STRING_VECTOR(DIAGNOSTIC_OUTPUT_TYPE,1,1,DYNAMIC_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)% &
            & TOTAL_NUMBER_OF_ROWS,5,5,DYNAMIC_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)%VARIABLE_DOF_TO_ROWS_MAP, &
            & '("        Variable DOF to rows maps :",5(X,I13))','(28X,5(X,I13))',ERR,ERROR,*999) 
        ENDDO !matrix_idx
      ...
      IF(ASSOCIATED(LINEAR_MAPPING)) THEN
        ...
        DO matrix_idx=1,LINEAR_MAPPING%NUMBER_OF_LINEAR_CONSTRAINT_MATRICES
          ...
          CALL WRITE_STRING_VECTOR(DIAGNOSTIC_OUTPUT_TYPE,1,1,LINEAR_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)% &
            & TOTAL_NUMBER_OF_ROWS,5,5,LINEAR_MAPPING%CONSTRAINT_MATRIX_ROWS_TO_VAR_MAP(matrix_idx)%VARIABLE_DOF_TO_ROWS_MAP, &
            & '("        Variable DOF to rows maps :",5(X,I13))','(28X,5(X,I13))',ERR,ERROR,*999) 
        ENDDO !matrix_idx
        CALL WRITE_STRING(DIAGNOSTIC_OUTPUT_TYPE,"    Column mappings:",ERR,ERROR,*999)
        CALL WRITE_STRING_VECTOR(DIAGNOSTIC_OUTPUT_TYPE,1,1,CONSTRAINT_MAPPING%TOTAL_NUMBER_OF_COLUMNS,5,5, &
      ...
      IF(ASSOCIATED(NONLINEAR_MAPPING)) THEN
        ...
        DO matrix_idx=1,NONLINEAR_MAPPING%NUMBER_OF_JACOBIAN_CONSTRAINT_MATRICES
          ...
          CALL WRITE_STRING_VECTOR(DIAGNOSTIC_OUTPUT_TYPE,1,1,NONLINEAR_MAPPING%CONSTRAINT_JACOBIAN_ROWS_TO_VAR_MAP(matrix_idx)% &
            & TOTAL_NUMBER_OF_ROWS,5,5,NONLINEAR_MAPPING%CONSTRAINT_JACOBIAN_ROWS_TO_VAR_MAP(matrix_idx)%VARIABLE_DOF_TO_ROWS_MAP, &
            & '("        Variable DOF to rows maps :",5(X,I13))','(28X,5(X,I13))',ERR,ERROR,*999) 
        ENDDO !matrix_idx
        CALL WRITE_STRING(DIAGNOSTIC_OUTPUT_TYPE,"    Column mappings:",ERR,ERROR,*999)
        CALL WRITE_STRING_VECTOR(DIAGNOSTIC_OUTPUT_TYPE,1,1,CONSTRAINT_MAPPING%TOTAL_NUMBER_OF_COLUMNS,5,5, &
    ...
    EXITS("CONSTRAINT_MAPPING_CALCULATE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_CALCULATE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_CREATE_FINISH(CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_CREATE_FINISH",ERR,ERROR,*999)
   ...
   ELSE
    ...
    EXITS("CONSTRAINT_MAPPING_CREATE_FINISH")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_CREATE_FINISH",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_CREATE_START(CONSTRAINT_EQUATIONS,CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_CREATE_START",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_CREATE_START")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_CREATE_START",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_CREATE_VALUES_CACHE_FINALISE(CREATE_VALUES_CACHE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_CREATE_VALUES_CACHE_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_CREATE_VALUES_CACHE_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_CREATE_VALUES_CACHE_FINALISE",ERR,ERROR)
    RETURN 1
 ...
 !
  ...
  SUBROUTINE CONSTRAINT_MAPPING_CREATE_VALUES_CACHE_INITIALISE(CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_CREATE_VALUES_CACHE_INITIALISE",ERR,ERROR,*998)
    ...
    ENDIF
    EXITS("CONSTRAINT_MAPPING_CREATE_VALUES_CACHE_INITIALISE")
    RETURN
...
998 ERRORSEXITS("CONSTRAINT_MAPPING_CREATE_VALUES_CACHE_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_DESTROY(CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_DESTROY",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_DESTROY")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_DESTROY",ERR,ERROR)
    RETURN 1
 ...
 !
  ...
  SUBROUTINE CONSTRAINT_MAPPING_CONSTR_MATRIX_TO_VAR_MAP_FINALISE(CONSTRAINT_MATRIX_TO_VAR_MAP,ERR,ERROR,*)
   ...
   !Local Variables
    ...
    ENTERS("CONSTRAINT_MAPPING_CONSTR_MATRIX_TO_VAR_MAP_FINALISE",ERR,ERROR,*999)
 
    IF(ALLOCATED(CONSTRAINT_MATRIX_TO_VAR_MAP%VARIABLE_DOF_TO_ROWS_MAP)) &
      & DEALLOCATE(CONSTRAINT_MATRIX_TO_VAR_MAP%VARIABLE_DOF_TO_ROWS_MAP)
    
    EXITS("CONSTRAINT_MAPPING_CONSTR_MATRIX_TO_VAR_MAP_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_CONSTR_MATRIX_TO_VAR_MAP_FINALISE",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_CONSTR_MATRIX_TO_VAR_MAP_INIT(CONSTRAINT_MATRIX_TO_VAR_MAP,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_CONSTR_MATRIX_TO_VAR_MAP_INIT",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_CONSTR_MATRIX_TO_VAR_MAP_INIT")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_CONSTR_MATRIX_TO_VAR_MAP_INIT",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_DYNAMIC_MAPPING_FINALISE(DYNAMIC_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_DYNAMIC_MAPPING_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_DYNAMIC_MAPPING_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_DYNAMIC_MAPPING_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_DYNAMIC_MAPPING_INITIALISE(CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_DYNAMIC_MAPPING_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_MAPPING_DYNAMIC_MAPPING_INITIALISE")
    RETURN
999 CALL CONSTRAINT_MAPPING_DYNAMIC_MAPPING_FINALISE(CONSTRAINT_MAPPING%DYNAMIC_MAPPING,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_MAPPING_DYNAMIC_MAPPING_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_ALL(CONSTRAINT_MAPPING,MASS_MATRIX,DAMPING_MATRIX,STIFFNESS_MATRIX, &
    ...
    ENTERS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_ALL",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_ALL_ORDER")
    RETURN
999 IF(ALLOCATED(OLD_DYNAMIC_MATRIX_COEFFICIENTS)) DEALLOCATE(OLD_DYNAMIC_MATRIX_COEFFICIENTS)    
    ERRORSEXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_ALL",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_1(CONSTRAINT_MAPPING,DAMPING_MATRIX,STIFFNESS_MATRIX,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_1",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_1")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_2(CONSTRAINT_MAPPING,MASS_MATRIX,DAMPING_MATRIX,STIFFNESS_MATRIX, &
    ...
    ENTERS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_2",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_2")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_SET_2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_1(CONSTRAINT_MAPPING,DAMPING_MATRIX_COEFFICIENT, &
    ...
    ENTERS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_1",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_1")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_1",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_2(CONSTRAINT_MAPPING,MASS_MATRIX_COEFFICIENT, &
    ...
    ENTERS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_2",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_2")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_COEFFS_SET_2",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_CONSTR_JACOBIAN_TO_VAR_MAP_FINALISE(CONSTRAINT_JACOBIAN_TO_VAR_MAP,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_CONSTR_JACOBIAN_TO_VAR_MAP_FINALISE",ERR,ERROR,*999)
    
    IF(ALLOCATED(CONSTRAINT_JACOBIAN_TO_VAR_MAP%VARIABLE_DOF_TO_ROWS_MAP)) &
      & DEALLOCATE(CONSTRAINT_JACOBIAN_TO_VAR_MAP%VARIABLE_DOF_TO_ROWS_MAP)
    
    EXITS("CONSTRAINT_MAPPING_CONSTR_JACOBIAN_TO_VAR_MAP_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_CONSTR_JACOBIAN_TO_VAR_MAP_FINALISE",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_CONSTR_JACOBIAN_TO_VAR_MAP_INIT(CONSTRAINT_JACOBIAN_TO_VAR_MAP,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_CONSTR_JACOBIAN_TO_VAR_MAP_INIT",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_CONSTR_JACOBIAN_TO_VAR_MAP_INIT")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_CONSTR_JACOBIAN_TO_VAR_MAP_INIT",ERR,ERROR)    
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_FINALISE(CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_FINALISE",ERR,ERROR)
    RETURN 1
 ...
 SUBROUTINE CONSTRAINT_MAPPING_INITIALISE(CONSTRAINT_EQUATIONS,ERR,ERROR,*)
   ...
   ENTERS("CONSTRAINT_MAPPING_INITIALISE",ERR,ERROR,*998)
...
998 ERRORSEXITS("CONSTRAINT_MAPPING_INITIALISE",ERR,ERROR)
 ...
 SUBROUTINE CONSTRAINT_MAPPING_LINEAR_MAPPING_FINALISE(LINEAR_MAPPING,ERR,ERROR,*)
   ...
   ENTERS("CONSTRAINT_MAPPING_LINEAR_MAPPING_FINALISE",ERR,ERROR,*999)
   ...
   EXITS("CONSTRAINT_MAPPING_LINEAR_MAPPING_FINALISE")
   RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_LINEAR_MAPPING_FINALISE",ERR,ERROR)
   RETURN 1
 ...
 !
  ...
  SUBROUTINE CONSTRAINT_MAPPING_LINEAR_MAPPING_INITIALISE(CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_LINEAR_MAPPING_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_MAPPING_LINEAR_MAPPING_INITIALISE")
    RETURN
999 CALL CONSTRAINT_MAPPING_LINEAR_MAPPING_FINALISE(CONSTRAINT_MAPPING%LINEAR_MAPPING,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_MAPPING_LINEAR_MAPPING_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_LINEAR_MATRICES_COEFFS_SET(CONSTRAINT_MAPPING,LINEAR_MATRIX_COEFFICIENTS,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_LINEAR_MATRICES_COEFFS_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_LINEAR_MATRICES_COEFFS_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_LINEAR_MATRICES_COEFFS_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_NONLINEAR_MAPPING_FINALISE(NONLINEAR_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_NONLINEAR_MAPPING_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_NONLINEAR_MAPPING_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_NONLINEAR_MAPPING_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_NONLINEAR_MAPPING_INITIALISE(CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_NONLINEAR_MAPPING_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_MAPPING_NONLINEAR_MAPPING_INITIALISE")
    RETURN
999 CALL CONSTRAINT_MAPPING_NONLINEAR_MAPPING_FINALISE(CONSTRAINT_MAPPING%NONLINEAR_MAPPING,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_MAPPING_NONLINEAR_MAPPING_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_JACOBIAN_COEFF_SET(CONSTRAINT_MAPPING,JACOBIAN_COEFFICIENT,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_JACOBIAN_COEFF_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_JACOBIAN_COEFF_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_JACOBIAN_COEFF_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_LAGRANGE_VARIABLE_TYPE_SET(CONSTRAINT_MAPPING,LAGRANGE_VARIABLE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_LAGRANGE_VARIABLE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_LAGRANGE_VARIABLE_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_LAGRANGE_VARIABLE_TYPE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_LINEAR_MATRICES_TRANSPOSE_SET(CONSTRAINT_MAPPING,LINEAR_MATRIX_TRANSPOSE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_LINEAR_MATRICES_TRANSPOSE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_LINEAR_MATRICES_TRANSPOSE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_LINEAR_MATRICES_TRANSPOSE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_DYNAMIC_MATRICES_TRANSPOSE_SET(CONSTRAINT_MAPPING,DYNAMIC_MATRIX_TRANSPOSE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_TRANSPOSE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_TRANSPOSE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_DYNAMIC_MATRICES_TRANSPOSE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_JACOBIAN_MATRICES_TRANSPOSE_SET(CONSTRAINT_MAPPING,JACOBIAN_MATRIX_TRANSPOSE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_JACOBIAN_MATRICES_TRANSPOSE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_JACOBIAN_MATRICES_TRANSPOSE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_JACOBIAN_MATRICES_TRANSPOSE_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_RHS_COEFF_SET(CONSTRAINT_MAPPING,RHS_COEFFICIENT,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_RHS_COEFF_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_RHS_COEFF_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_RHS_COEFF_SET",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_RHS_MAPPING_FINALISE(RHS_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_RHS_MAPPING_FINALISE",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_RHS_MAPPING_FINALISE")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_RHS_MAPPING_FINALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_RHS_MAPPING_INITIALISE(CONSTRAINT_MAPPING,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_RHS_MAPPING_INITIALISE",ERR,ERROR,*998)
    ...
    EXITS("CONSTRAINT_MAPPING_RHS_MAPPING_INITIALISE")
    RETURN
999 CALL CONSTRAINT_MAPPING_RHS_MAPPING_FINALISE(CONSTRAINT_MAPPING%RHS_MAPPING,DUMMY_ERR,DUMMY_ERROR,*998)
998 ERRORSEXITS("CONSTRAINT_MAPPING_RHS_MAPPING_INITIALISE",ERR,ERROR)
    RETURN 1
  ...
  SUBROUTINE CONSTRAINT_MAPPING_RHS_VARIABLE_TYPE_SET(CONSTRAINT_MAPPING,RHS_VARIABLE_TYPE,ERR,ERROR,*)
    ...
    ENTERS("CONSTRAINT_MAPPING_RHS_VARIABLE_TYPE_SET",ERR,ERROR,*999)
    ...
    EXITS("CONSTRAINT_MAPPING_RHS_VARIABLE_TYPE_SET")
    RETURN
999 ERRORSEXITS("CONSTRAINT_MAPPING_RHS_VARIABLE_TYPE_SET",ERR,ERROR)
    RETURN 1
