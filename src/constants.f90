...
MODULE CONSTANTS
  ...
  INTEGER(INTG) :: PARTIAL_DERIVATIVE_MIXED_SECOND_DERIVATIVES_MAP(4,4) = RESHAPE( &
    ...
    &   PART_DERIV_S1_S4,PART_DERIV_S2_S4,PART_DERIV_S3_S4,PART_DERIV_S4_S4 ], [4,4])
  !<PARTIAL_DERIVATIVE_MIXED_SECOND_DERIVATIVES_MAP(nic1,nic2) gives the partial derivative index for the mixed second derivatives in the (ni(c)1'th,ni(c)2'th) direction
